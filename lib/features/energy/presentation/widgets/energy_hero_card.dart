...
class EnergyHeroCard extends StatelessWidget {
  ...
  const EnergyHeroCard({super.key, required this.summary});
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(
                          summary.percentVsYesterday < 0 ? Icons.trending_down :
                          Icons.trending_up,
                        ...
                        const SizedBox(width: 4),
                        Text(
                          "${(summary.percentVsYesterday.abs()*100).toInt()}% vs yesterday",
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 13,
                            fontWeight: FontWeight.w600,
